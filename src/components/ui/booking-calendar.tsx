          ...
          >
            ...
            >
                            ...
                            <div className="flex items-center justify-between w-full">
                              <motion.h2 className="mb-2 text-4xl font-bold tracking-wider text-gray-800">
                                {selectedDate ? `Κρατήσεις ${new Date(selectedDate).toLocaleDateString('el-GR', { day: 'numeric', month: 'long', year: 'numeric' })}` : 'Κρατήσεις'}
                              </motion.h2>
                              {selectedDate && (
                                <button
                            ...
                            <p className="font-medium text-gray-600">
                              {selectedDate 
                                ? `Κρατήσεις για την ημερομηνία ${new Date(selectedDate).toLocaleDateString('el-GR', { day: 'numeric', month: 'long', year: 'numeric' })}`
